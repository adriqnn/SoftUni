...
BEGIN
SELECT a.name,cl.full_name,(CASE WHEN c.bill <= 20 THEN 'Low'WHEN c.bill <= 30 THEN 'Medium'WHEN c.bill > 30 THEN 'High'END),cr.make,cr.`condition`,ct.name FROM courses AS c
