...
public class _05_Numbers {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numbersList.size(); i++) {
            if(numbersList.get(i) == number){
                numbersList = removeNumbersFromListWithPower(numbersList,i,number,power);
                i--;
            }
        }
    ...
    private static List<Integer> removeNumbersFromListWithPower(List<Integer> numbersList, int i, int number, int power) {
