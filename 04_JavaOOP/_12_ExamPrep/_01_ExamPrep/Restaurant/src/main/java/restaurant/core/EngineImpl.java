...
public class EngineImpl implements Engine {
    ...
    private String processInput() throws IOException {
        ...
        switch (command) {
            case addHealthyFood:
                result = this.controller.addHealthyFood(data[0], Double.parseDouble(data[1]), data[2]);
                break;

            case addBeverage:
                result = this.controller.addBeverage(data[0], Integer.parseInt(data[1]), data[2],  data[3]);
                break;
