...
public class Farm {
    ...
    public void add(Animal animal) {
        ...
        boolean animalExists = this.animals.stream().anyMatch(a -> a.getType().equals(animal.getType()));
    ...
    public boolean remove(String animalType) {
        Animal animal = this.animals.stream().filter(a -> a.getType().equals(animalType)).findFirst().orElse(null);
