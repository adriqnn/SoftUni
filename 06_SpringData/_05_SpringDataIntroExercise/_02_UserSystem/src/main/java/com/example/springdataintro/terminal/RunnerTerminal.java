package com.example.springdataintro.terminal;

import com.example.springdataintro.entity.User;
import com.example.springdataintro.services.interfaces.*;
...
public class RunnerTerminal implements CommandLineRunner {
    ...
    private com.example.springdataintro.services.interfaces.UserService userService;
