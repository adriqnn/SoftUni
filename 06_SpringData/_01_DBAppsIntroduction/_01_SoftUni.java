...
public class _01_SoftUni {
    private static final String URL = "jdbc:mysql://localhost:3306/diablo";
    private static final String USER = "root";
    private static String PASSWORD = "MySQL99zzzMySQL99zzzMySQL99zzz";
    ...
    public static void main(String[] args) throws IOException, SQLException {
        ...
        try(Connection connection = DriverManager.getConnection(URL, USER, PASSWORD)) {
            ...
            //* To be save from SQL injections - use always PrepareStatement (when u expect data for your query from the user)
