...
import com.example.jsonprocessing.model.dto.bindingModel.seedDataDTOs.*;
import com.example.jsonprocessing.model.dto.viewModel.query2.CarDTO;
import com.example.jsonprocessing.model.dto.viewModel.query2.CarWrapper;
import com.example.jsonprocessing.model.dto.viewModel.query3.LocalSupplierDTO;
import com.example.jsonprocessing.model.dto.viewModel.query3.LocalSupplierWrapper;
import com.example.jsonprocessing.model.dto.viewModel.query4.CarViewModel;
import com.example.jsonprocessing.model.dto.viewModel.query4.CarViewModelWrapper;
import com.example.jsonprocessing.model.dto.viewModel.query5.CustomerViewModel;
import com.example.jsonprocessing.model.dto.viewModel.query5.CustomerWrapper;
import com.example.jsonprocessing.model.dto.viewModel.query6.SaleViewModel;
import com.example.jsonprocessing.model.dto.viewModel.query6.SaleWrapper;
import com.example.jsonprocessing.service.*;
import com.example.jsonprocessing.utils.serialize.Serializer;
...
//        seedDataIntoDB();
    ...
    private void orderedCustomers() {
        List<com.example.jsonprocessing.model.dto.viewModel.query1.CustomerViewModel> customerViewModel =
        ...
        com.example.jsonprocessing.model.dto.viewModel.query1.CustomerWrapper customerWrapper = new com.example.jsonprocessing.model.dto.viewModel.query1.CustomerWrapper(customerViewModel);
