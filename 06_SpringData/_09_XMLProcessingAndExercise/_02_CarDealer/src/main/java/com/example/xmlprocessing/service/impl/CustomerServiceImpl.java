...
import com.example.xmlprocessing.model.entity.Sale;
import com.example.xmlprocessing.repository.CustomerRepository;
import com.example.xmlprocessing.service.CustomerService;
...
//                DtoConvertUtil.convert(orderedCustomers, CustomerViewModelQuery1.class);
    ...
    @Override
    public List<com.example.xmlprocessing.model.dto.viewModel.query5.CustomerViewModel> getAllWithMinOneBoughtCar() {
        List<Customer> customerList = this.customerRepository.getAllWithMinOneBoughtCar();
        List<com.example.xmlprocessing.model.dto.viewModel.query5.CustomerViewModel> viewModel =
                customerList.stream().map(c -> {
                    com.example.xmlprocessing.model.dto.viewModel.query5.CustomerViewModel model = new com.example.xmlprocessing.model.dto.viewModel.query5.CustomerViewModel();
