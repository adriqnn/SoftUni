...
const MyTeamsView = context => {
    const NoTeamsComponent = html `<article class="layout narrow">
                                       <div class="pad-med">
    ...
    const SingleTeamComponent = teamData => {
        ...
        return html `<article class="layout">
                         ...
                         <div class="tm-preview">
                             ...
                             <span class="details">${teamMembers} Member${teamMembers === 1 ? nothing : 's'}</span>
    ...
    return html `<section id="my-teams">
                     ...
                     ${context.myTeams.length > 0 ? context.myTeams.map(x => SingleTeamComponent(x)) : NoTeamsComponent}
                 </section>`;
}
