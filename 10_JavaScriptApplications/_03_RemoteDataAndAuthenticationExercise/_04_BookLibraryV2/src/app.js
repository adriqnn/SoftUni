...
import { updateBook, displayEditForm } from './edit.js';
import { createBook, createBookElement } from './create.js';

const [submitForm, editForm] = [document.getElementById('submitForm'), document.getElementById('editForm')];
