...
const createHTML = eFactory('div', 'container home wrapper  my-md-5 pl-md-5', ` <div class=" d-md-flex flex-mb-equal ">
                                                                                    <div class="col-md-6">
                                                                                    ...
                                                                                    <form class="form-idea col-md-5" action="#/create" method="post">
                                                                                        ...
                                                                                        <div class="form-label-group">
                                                                                            ...
                                                                                            <input type="text" id="inputURL" name="img" class="form-control" placeholder="Image URL" required="">                                                                                                  
                                                                                        </div>
