...
const host = 'http://localhost:63343/.../_04_FillDropdown'; // Application host (NOT service host - that can be anything)
const DEBUG = false;

const interval = 300;
const slowMo = 500;

const mockData = { "catalog": [{ "text": "Rome", "_id": "1001" }, { "text": "Amsterdam", "_id": "1002" }] };
const endpoints = { catalog: '/jsonstore/advanced/dropdown' };
