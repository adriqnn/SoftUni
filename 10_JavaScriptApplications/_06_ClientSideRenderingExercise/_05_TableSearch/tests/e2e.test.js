...
const host = 'http://localhost:63343/.../_05_TableSearch'; // Application host (NOT service host - that can be anything)
const DEBUG = false;
const interval = 300;
const slowMo = 500;
...
const endpoints = { catalog: '/jsonstore/advanced/table' };
