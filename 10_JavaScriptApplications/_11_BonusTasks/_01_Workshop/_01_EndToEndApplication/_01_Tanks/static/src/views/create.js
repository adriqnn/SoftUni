...
const createTemplate = (onSubmit, error) => html `<section class="narrow">
                                                      <h1>Create Game Lobby</h1>
                                                      <form @submit=${onSubmit}>${error ? html `<p class="error-msg">${error}</p>` : nothing}
                                                          <div class="form-align">
                                                              <label class="form-row"><span>Lobby name</span><input type="text" name="name"></label>
                                                              <label class="form-row"><span>Game mode</span>
                                                                  <select name="mode">
