const getNavBarLinks = () => JSON.stringify(sessionStorage) === '{}' ? ['Login', 'Register'] : [`Welcome, ${sessionStorage.email}`, 'Logout'];
...
const deserializeFormData = (form) => Object.fromEntries([...form.entries()]);
...
export { getNavBarLinks, eFactory, displayMsg, deserializeFormData, isValidInput, clearFormFields, checkServerError, parseMovieData, userLoggedIn };
