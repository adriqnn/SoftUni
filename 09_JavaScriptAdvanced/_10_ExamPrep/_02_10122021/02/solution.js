...
// revision(){
    //     let string1 = 'Available vegetables:';
    //     let string2 = this.availableProducts.sort((a,b) => a.type.localeCompare(b.type)).map(p => `${p.type}-${p.quantity}-$${p.price}`);
    //     let string3 = `The owner of the store is ${this.owner}, and the location is ${this.location}.`;
    // }
// let vegStore = new VegetableStore("Jerrie Munro", "1463 Pette Kyosheta,Sofia");
// console.log(vegStore.loadingVegetables(["Okra 2.5 3.5","Okra 2.5 3.5","Okra 2.5 3.5","Okra 2.5 3.5", "Beans 10 2.8","Celery 5.5 2.2", "Celery 0.5 2.5"]));
...
//         price: 0
//     }
//     let each = vegetable[i].split(' ');
//     vegetable.type = each[0];
//     vegetable.quantity = each[1]
//     vegetable.price = each[2];
