...
public class TreeTest {
    ...
    @Test
    public void testPathsWithGivenSum2() {
        String[] input = {
                "7 19",
                "7 21",
                "7 14",
    ...
    @Test
    public void testTreesWithGivenSumMS() {
        String[] input = {
                "7 19",
                "7 21",
                "7 14",
        ...
        TreeFactory treeFactory = new TreeFactory();
        Tree<Integer> tree = treeFactory.createTreeFromStrings(input);
        List<Tree<Integer>> trees = tree.subTreesWithGivenSumMySolution(43);
        String asString = trees.get(0).getAsString();
    ...
    @Test
    public void testTreesWithGivenSum2MS() {
        String[] input = {
                "7 19",
                "7 21",
                "7 14",
