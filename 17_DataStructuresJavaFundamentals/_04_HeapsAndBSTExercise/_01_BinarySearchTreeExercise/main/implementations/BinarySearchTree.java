...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    public boolean contains(E element) {
        // Iterative
        return containsNodeIterative(this.root, element) != null;

//        return containsNode(this.root, element);  //Recursion boolean
//        return containsNodeRecursionNode(this.root, element); // Recursion node
    }
    ...
    private Node<E> containsNodeRecursionNode(Node<E> node ,E element) {
        if(node == null){
            return null;
        }
        ...
        if(isEqual(element, node)){
            ...
            return containsNodeRecursionNode(node.getRight(), element);
        }

        return containsNodeRecursionNode(node.getLeft(), element);

    }

    private Node<E> containsNodeIterative(Node<E> node, E element){
        // Iterative
        Node<E> current = node;
    ...
    public BinarySearchTree<E> search(E element) {
        Node<E> found = containsNodeIterative(this.root, element);
