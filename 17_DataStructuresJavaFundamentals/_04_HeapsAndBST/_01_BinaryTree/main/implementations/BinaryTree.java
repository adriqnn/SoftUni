...
public class BinaryTree<E> implements AbstractBinaryTree<E> {
    ...
    public String asIndentedPreOrder(int indent) {
        ...
        if(this.getLeft() != null){
            String leftChild = this.getLeft().asIndentedPreOrder(indent + 2);
            result.append(System.lineSeparator()).append(leftChild);
        }

        if(this.getRight() != null){
            String rightChild = this.getRight().asIndentedPreOrder(indent + 2);
            result.append(System.lineSeparator()).append(rightChild);
        }
