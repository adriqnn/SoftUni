...
public class Competition {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && score == that.score && Objects.equals(name, that.name) && Objects.equals(competitors, that.competitors);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, score, competitors);
    }
}
