...
public class MessagingSystemTest {
    ...
    public void testGetPostOrderShouldReturnCorrectSequence() {
        ...
        System.out.println(this.system.size());
    ...
    public void testContains() {
        ...
        for (int i = 0; i < messages.size(); i++) {
            assertEquals(expected[i], postOrder.get(i).getWeight());
            assertTrue(this.system.contains(postOrder.get(i)));
            assertFalse(this.system.contains(new TextMessage(2313123, "10")));
        }

    }

    @Test
    public void testByWeightHappyPath() {
        Message byWeight = this.system.getByWeight(17);
        assertEquals(17, byWeight.getWeight());
    }

    @Test(expected = IllegalArgumentException.class)
    public void testByWeightException() {
        this.system.getByWeight(2323);
    }
}